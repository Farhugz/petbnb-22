...
pet_home1.photo.attach(io: file1, filename: "nes.png", content_type: "image/png")
pet_home1.save
...
pet_home2.photo.attach(io: file2, filename: "nes.png", content_type: "image/png")
pet_home2.save
...
pet_home3 = PetHome.new(user: User.third,
                        ...
                        start_date: Date.today,
                        end_date: Date.tomorrow)
pet_home3.photo.attach(io: file3, filename: "nes.png", content_type: "image/png")
pet_home3.save
...
pet_home4 = PetHome.new(user: User.first,
                        ...
                        start_date: Date.today,
                        end_date: Date.tomorrow)
pet_home4.photo.attach(io: file4, filename: "nes.png", content_type: "image/png")
pet_home4.save
...
pet_home5 = PetHome.new(user: User.second,
                        ...
                        start_date: Date.today,
                        end_date: Date.tomorrow)
pet_home5.photo.attach(io: file5, filename: "nes.png", content_type: "image/png")
pet_home5.save
...
pet_home6 = PetHome.new(user: User.third,
                        ...
                        start_date: Date.today,
                        end_date: Date.tomorrow)
pet_home6.photo.attach(io: file6, filename: "nes.png", content_type: "image/png")
pet_home6.save
...
pet_home7 = PetHome.new(user: User.first,
                        ...
                        start_date: Date.today,
                        end_date: Date.tomorrow)
pet_home7.photo.attach(io: file7, filename: "nes.png", content_type: "image/png")
pet_home7.save
...
pet_home8 = PetHome.new(user: User.second,
                        ...
                        start_date: Date.today,
                        end_date: Date.tomorrow,)
pet_home8.photo.attach(io: file8, filename: "nes.png", content_type: "image/png")
pet_home8.save
...
pet_home9 = PetHome.new(user: User.third,
                        ...
                        start_date: Date.today,
                        end_date: Date.tomorrow)
pet_home9.photo.attach(io: file9, filename: "nes.png", content_type: "image/png")
pet_home9.save
...
pet_home10 = PetHome.new(user: User.first,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home10.photo.attach(io: file10, filename: "nes.png", content_type: "image/png")
pet_home10.save
...
pet_home11 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home11.photo.attach(io: file11, filename: "nes.png", content_type: "image/png")
pet_home11.save
...
pet_home12 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home12.photo.attach(io: file12, filename: "nes.png", content_type: "image/png")
pet_home12.save
...
pet_home13 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home13.photo.attach(io: file13, filename: "nes.png", content_type: "image/png")
pet_home13.save
...
pet_home14 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home14.photo.attach(io: file14, filename: "nes.png", content_type: "image/png")
pet_home14.save
...
pet_home15 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home15.photo.attach(io: file15, filename: "nes.png", content_type: "image/png")
pet_home.save
...
pet_home16 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home16.photo.attach(io: file16, filename: "nes.png", content_type: "image/png")
pet_home16.save
...
pet_home17 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home17.photo.attach(io: file17, filename: "nes.png", content_type: "image/png")
pet_home17.save
...
pet_home18 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home18.photo.attach(io: file18, filename: "nes.png", content_type: "image/png")
pet_home18.save
...
pet_home19 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home19.photo.attach(io: file19, filename: "nes.png", content_type: "image/png")
pet_home19.save
...
pet_home20 = PetHome.new(user: User.fourth,
                          ...
                          start_date: Date.today,
                          end_date: Date.tomorrow)
pet_home20.photo.attach(io: file20, filename: "nes.png", content_type: "image/png")
pet_home20.save
